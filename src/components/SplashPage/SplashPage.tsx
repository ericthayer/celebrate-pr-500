...
const CODE_SNIPPETS = [
  ...
  { text: 'git push origin main', top: '20%', right: '4%', delay: '1.2s', duration: '22s' },
  { text: '✓ All checks passed', top: '35%', left: '2%', delay: '2s', duration: '20s' },
  { text: '$ npm run build ✓', top: '65%', right: '3%', delay: '0.8s', duration: '19s' },
  { text: 'Approved by 2 reviewers', top: '75%', left: '1%', delay: '1.5s', duration: '24s' },
  { text: 'git log --oneline | wc -l', top: '82%', right: '5%', delay: '0.3s', duration: '21s' },
];
